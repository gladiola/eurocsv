# EuroCSV — Conversor de localização CSV

O EuroCSV ajuda equipas a converter ficheiros CSV entre formatos internacionais usados em negócios. A aplicação ajusta delimitadores, separadores decimais, separadores de milhar e formatos de data para que os dados sejam importados corretamente na localidade de destino.

> **Nota:** pt-BR utiliza normalmente `;` como delimitador de campos, `,` como separador decimal, `.` como separador de milhar e `dd/MM/yyyy` como formato de data.

---

## Convenções CSV por localidade

| Localidade | Delimitador | Decimal | Milhar | Formato de data |
|---|---|---|---|---|
...
Carregue o seu ficheiro CSV, selecione a localidade de origem e destino e transfira o ficheiro convertido.
