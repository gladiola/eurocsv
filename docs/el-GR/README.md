# EuroCSV — Μετατροπέας τοπικής ρύθμισης CSV

Το EuroCSV βοηθά τις ομάδες να μετατρέπουν αρχεία CSV μεταξύ διεθνών επιχειρηματικών μορφών. Η εφαρμογή προσαρμόζει οριοθέτες, δεκαδικά σύμβολα, διαχωριστικά χιλιάδων και μορφές ημερομηνίας ώστε τα δεδομένα να εισάγονται σωστά στην τοπική ρύθμιση προορισμού.

> **Σημείωση:** Το el-GR χρησιμοποιεί συνήθως `;` ως οριοθέτη πεδίων, `,` ως δεκαδικό διαχωριστικό, `.` ως διαχωριστικό χιλιάδων και `dd/MM/yyyy` ως μορφή ημερομηνίας.

---

## Συμβάσεις CSV ανά τοπική ρύθμιση

| Τοπικές ρυθμίσεις | Οριοθέτης | Δεκαδικό | Χιλιάδες | Μορφή ημερομηνίας |
|---|---|---|---|---|
...
Ανεβάστε το αρχείο CSV σας, επιλέξτε τις τοπικές ρυθμίσεις προέλευσης και προορισμού και κατεβάστε το μετατραπμένο αρχείο.
