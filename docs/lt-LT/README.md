# EuroCSV — CSV lokalizacijos konverteris

EuroCSV padeda komandoms konvertuoti CSV failus tarp tarptautinių verslo formatų. Programa pritaiko skyriklius, dešimtainius ženklus, tūkstančių skirtukus ir datos formatus, kad duomenys būtų teisingai importuojami į tikslinius vietinius nustatymus.

> **Pastaba:** lt-LT paprastai naudoja `;` kaip laukų skyriklį, `,` kaip dešimtainį skirtuką, `space` kaip tūkstančių skirtuką ir `yyyy-MM-dd` kaip datos formatą.

---

## CSV taisyklės pagal vietinius nustatymus

| Vietiniai nustatymai | Skyriklis | Dešimtainis | Tūkstančiai | Datos formatas |
|---|---|---|---|---|
...
Įkelkite savo CSV failą, pasirinkite šaltinio ir paskirties vietinius nustatymus, tada atsisiųskite konvertuotą failą.
