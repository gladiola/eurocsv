# EuroCSV — CSV-lokalisointimuunnin

EuroCSV auttaa tiimejä muuntamaan CSV-tiedostoja kansainvälisten liiketoimintamuotojen välillä. Sovellus mukauttaa erottimet, desimaalimerkit, tuhaterottimet ja päivämäärämuodot, jotta tiedot tuodaan oikein kohdealueelle.

> **Huom:** fi-FI käyttää yleensä `;`-merkkiä kenttäerottimena, `,`-merkkiä desimaalierottimena, `space`-merkkiä tuhaterottimena ja `dd.MM.yyyy`-muotoa päivämäärissä.

---

## CSV-käytännöt alueellisten asetusten mukaan

| Alueelliset asetukset | Erotin | Desimaali | Tuhaterotin | Päivämäärämuoto |
|---|---|---|---|---|
...
Lataa CSV-tiedostosi, valitse lähde- ja kohdealueelliset asetukset ja lataa sitten muunnettu tiedosto.
