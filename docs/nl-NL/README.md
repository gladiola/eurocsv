# EuroCSV — CSV-localisatieconverter

EuroCSV helpt teams om CSV-bestanden betrouwbaar om te zetten tussen internationale bedrijfsformaten. De toepassing past scheidingstekens, decimale notatie, duizendtalscheiding en datumnotaties aan zodat gegevens correct in de doellandinstelling worden geïmporteerd.

> **Opmerking:** nl-NL gebruikt meestal `;` als veldscheidingsteken, `,` als decimaalteken, `.` als duizendtalscheiding en `dd-MM-yyyy` als datumnotatie.

---

## CSV-conventies per landinstelling

| Landinstelling | Scheidingsteken | Decimaal | Duizendtallen | Datumnotatie |
|---|---|---|---|---|
...
Upload uw CSV-bestand, selecteer de bron- en doellandinstelling en download het geconverteerde bestand.
