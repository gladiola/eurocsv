# EuroCSV — CSV-lokaliseringskonverterer

EuroCSV hjelper team med å konvertere CSV-filer mellom internasjonale forretningsformater. Verktøyet tilpasser skilletegn, desimalskilletegn, tusenskiller og datoformat slik at data importeres riktig i målinnstillingen.

> **Merk:** nb-NO bruker vanligvis `;` som feltskilletegn, `,` som desimalskilletegn, `space` som tusenskiller og `dd.MM.yyyy` som datoformat.

---

## CSV-konvensjoner etter nasjonal innstilling

| Nasjonal innstilling | Skilletegn | Desimal | Tusen | Datoformat |
|---|---|---|---|---|
...
Last opp CSV-filen din, velg kilde- og målnasjonal innstilling, og last ned den konverterte filen.
