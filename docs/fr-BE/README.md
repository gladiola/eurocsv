...
> **Remarque:** fr-BE utilise généralement `;` comme délimiteur de champs, `,` comme séparateur décimal, `.` comme séparateur de milliers et `dd/MM/yyyy` comme format de date.
