# EuroCSV — CSV lokalizācijas konvertētājs

EuroCSV palīdz komandām konvertēt CSV failus starp starptautiskiem biznesa formātiem. Lietotne pielāgo atdalītājus, decimāldaļas zīmes, tūkstošu atdalītājus un datuma formātus, lai dati tiktu pareizi importēti mērķa lokāles iestatījumos.

> **Piezīme:** lv-LV parasti izmanto `;` kā lauku atdalītāju, `,` kā decimāldaļas atdalītāju, `space` kā tūkstošu atdalītāju un `dd.MM.yyyy` kā datuma formātu.

---

## CSV konvencijas pēc lokāles iestatījumiem

| Lokāles iestatījumi | Atdalītājs | Decimāldaļa | Tūkstošu atdalītājs | Datuma formāts |
|---|---|---|---|---|
...
Augšupielādējiet savu CSV failu, atlasiet avota un mērķa lokāles iestatījumus, pēc tam lejupielādējiet konvertēto failu.
