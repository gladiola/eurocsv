# EuroCSV — Převodník lokalizace CSV

EuroCSV pomáhá týmům převádět soubory CSV mezi mezinárodními obchodními formáty. Upravuje oddělovače, desetinné značky, oddělovače tisíců a formáty data tak, aby se data správně importovala do cílového národního prostředí.

> **Poznámka:** cs-CZ obvykle používá `;` jako oddělovač polí, `,` jako desetinný oddělovač, `space` jako oddělovač tisíců a `dd.MM.yyyy` jako formát data.

---

## Konvence CSV podle národního prostředí

| Národní prostředí | Oddělovač | Desetinný | Tisíce | Formát data |
|---|---|---|---|---|
...
Nahrajte svůj soubor CSV, vyberte zdrojové a cílové národní prostředí a stáhněte převedený soubor.
